...
def run_sequential(n):
    ...
    all_tournaments = list(tournaments_gen) 
    ...
    for i, T in enumerate(all_tournaments):
        ...
        class_info["tournaments"].append(T)
